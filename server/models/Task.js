...
class Task{
    constructor(_taskname, _taskdesc, _tasknotes, _taskid, _taskplan, _taskappacro, _taskstate, _taskcreator, _taskowner, _taskcreatedate, _taskaudittrail){
        ...
        this.taskaudittrail = _taskaudittrail
    }
}
...
function pipeResponseAsTaskList(objlist){
    const mylist = [];
    objlist.forEach(obj => {
        const tt = new Task(obj.Task_name, obj.Task_description, obj.Task_notes, obj.Task_id, obj.Task_plan, obj.Task_App_Acronym, obj.Task_state, obj.Task_creator, obj.Task_owner, obj.Task_createDate, obj.Task_auditTrail);
        mylist.push(tt);
    });
    return mylist;
}
